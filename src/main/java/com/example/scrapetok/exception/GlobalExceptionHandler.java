...
public class GlobalExceptionHandler {
    ...
    // Error cuando entity no es encontrada
    ...
    // Error de validación de DTOs (campos requeridos, etc.)
    ...
    // Error de conexión con Apify
    @ExceptionHandler(ApifyConnectionException.class)
    public ResponseEntity<ApiError> handleApifyConnection(ApifyConnectionException ex, HttpServletRequest request) {
        ApiError error = new ApiError(
    ...
    // Servicio no disponible (Apify u otros externos)
    ...
    // Bad request explícito por argumento inválido
